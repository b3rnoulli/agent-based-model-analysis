function [f]=plot_volatility_cross_correlation(f, file_path_resolver, file_name_resolver, display_name_resolver, params)
...
for iterator=1:length(params)
    ...
    loglog(abs(data.volatility_xcorr),'LineWidth',2,'DisplayName',display_name_resolver(param_array));
    hold on;
end
